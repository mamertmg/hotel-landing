  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-black rounded-md w-9 font-normal text-[0.8rem] dark:text-slate-400",
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-[15px] font-medium"
        ),
        day_range_end: "day-range-end",
        day_selected:'bg-soft_green text-white',
        day_today: "bg-soft_green-secondary",
        day_outside:
